...
public class AdminServlet extends HttpServlet {
    ...
    private static final List<String> partidasConGanador = Collections.synchronizedList(new ArrayList<>());
    ...
    private boolean verificarGanadores(Partida partida) {
        if (partidasConGanador.contains(partida.getId())) return true;
